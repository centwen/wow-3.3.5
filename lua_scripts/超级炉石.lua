...
function ST.SummonENPC(player)--召唤新手导师
	ST.SummonNPC(player, ST.NPCID2)
end
function ST.SummonNPC_4000001(player)--召唤新手导师
	ST.SummonNPC(player, 4000001)
end
...
function ST.SummonNPC_4003004(player)
	ST.SummonNPC(player, 4003004)
end
...
local Menu={
	[MMENU]={--主菜单
	    ...
	    {TP,   "|TInterface/ICONS/Achievement_Reputation_08:35:35|t|cffff0000商业中心|r(|cff0000ff招募机器人|r)", 1, -8545.5, 2005.471, 100.349, 1,	TEAM_NONE},
		{MENU, "|TInterface/ICONS/INV_Misc_Rune_06:35:35|t定点传送", 	 TBMENU,			GOSSIP_ICON_TAXI},
		...
		{MENU, "|TInterface/ICONS/INV_Misc_Book_09:35:35|t其他功能",		MMENU+0x10,		GOSSIP_ICON_TABARD},
	},

	[TBMENU]={--定点传送
		{FUNC, "|TInterface/ICONS/Spell_Arcane_TeleportStormWind:35:35|t定1号点",		Stone.TBPoint1,	GOSSIP_ICON_TAXI,	false,"是否记录当前|cFFF0F000位置|r ?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_PortalShattrath:35:35|t传到1号点免费",	    Stone.TTPoint1,	GOSSIP_ICON_TAXI,	false,"是否穿越回|cFFF0F000记录位置|r ?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_TeleportTheramore:35:35|t定2号点",		Stone.TBPoint2,	GOSSIP_ICON_TAXI,	false,"是否记录当前|cFFF0F000位置|r 2号点传回1金1次?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_PortalStonard:35:35|t传到2号点 1金/次",	    Stone.TTPoint2,	GOSSIP_ICON_TAXI,	false,"是否穿越回|cFFF0F000记录位置|r ?",10000},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_TeleportThunderBluff:35:35|t定3号点",		Stone.TBPoint3,	GOSSIP_ICON_TAXI,	false,"是否记录当前|cFFF0F000位置|r 3号点传回2金1次?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_PortalTheramore:35:35|t传到3号点 2金/次",	    Stone.TTPoint3,	GOSSIP_ICON_TAXI,	false,"是否穿越回|cFFF0F000记录位置|r ?",20000},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_TeleportUnderCity:35:35|t定4号点",		Stone.TBPoint4,	GOSSIP_ICON_TAXI,	false,"是否记录当前|cFFF0F000位置|r 4号点传回3金1次?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_PortalThunderBluff:35:35|t传到4号点 3金/次",	    Stone.TTPoint4,	GOSSIP_ICON_TAXI,	false,"是否穿越回|cFFF0F000记录位置|r ?",30000},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_TeleportStonard:35:35|t定5号点",		Stone.TBPoint5,	GOSSIP_ICON_TAXI,	false,"是否记录当前|cFFF0F000位置|r 5号点传回4金1次?"},
		{FUNC, "|TInterface/ICONS/Spell_Arcane_PortalUnderCity:35:35|t传到5号点 4金/次",	    Stone.TTPoint5,	GOSSIP_ICON_TAXI,	false,"是否穿越回|cFFF0F000记录位置|r ?",40000},	--增加收费金额参数,默认情况下失败也会扣金币，因此在失败时返还金币，在游戏里也不会出现减钱再加钱
	},
	...
	[MMENU+0x10]={--其他功能
		...
		{MENU, "|TInterface/ICONS/Spell_Arcane_Rune:35:35|t召唤材料商人", 	BUYMENU+0x10,	GOSSIP_ICON_VENDOR},
	    {FUNC, "|TInterface/ICONS/Spell_Holy_DevineAegis:35:35|t召唤幻化大师", 	ST.SummonNPC_4003004,	GOSSIP_ICON_TRAINER},
		{MENU, "|TInterface/ICONS/Spell_Holy_HolyGuidance:35:35|t提升专业技能",  SYMENU,	GOSSIP_ICON_TRAINER},
	},
	...
	[GMMENU]={--GM菜单
		...
		{FUNC, "|TInterface/ICONS/Ability_Rogue_Disguise:35:35|t重置容貌",		Stone.ResetFace,	GOSSIP_ICON_CHAT,		false,"是否重置容貌？\n|cFFFFFF00需要返回角色选择或者重新登录才能修改。|r"},
		...
		{FUNC, "|TInterface/ICONS/Spell_Holy_BorrowedTime:35:35|t重置所有冷却",	Stone.ResetAllCD,		GOSSIP_ICON_INTERACT_1,	false,"确认重置所有冷却 ?"},
	...
	[TPMENU]={--主菜单
		...
		{MENU,  "|TInterface/ICONS/Achievement_Arena_2v2_7:35:35|t|cFF9932CC站场传送",						TPMENU+0xb0,	GOSSIP_ICON_BATTLE},
		{MENU,  "|TInterface/ICONS/Spell_Arcane_Portalstormwind:35:35|t|cff0000ff传送到职业训练",    				MMENU+0x20,		GOSSIP_ICON_TAXI},
		{MENU,  "|TInterface/ICONS/Spell_Arcane_PortalOrgrimmar:35:35|t|cffff0000传送到技能训练",    				MMENU+0x30,		GOSSIP_ICON_TAXI},
	...
	[TPMENU+0x10]={--主要城市
	    ...
	    {TP, "|TInterface/ICONS/Spell_Arcane_PortalOrgrimmar:35:35|t|cffff0000奥格瑞玛",		1,		1621.08,	-4378.69,	9.9846,		2.14362,	TEAM_HORDE},
